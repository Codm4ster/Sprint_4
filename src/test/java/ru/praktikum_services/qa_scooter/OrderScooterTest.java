...
public class OrderScooterTest {
    ...
    public static Object [][] getScooterOrder(){
        return new Object[][] {
                {"Body", "Александр", "Пушкин", "Бабаевская, 7", 10, "+79998885522", "28.03.2024", "двое суток", "grey", "Позвоните мне"},
                {"Header", "Илон", "Маск", "Арбат, 40", 77, "+78882226677", "27.03.2024", "трое суток", "black", "Только наличные"}
        };
    }
